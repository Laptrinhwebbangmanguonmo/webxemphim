...
if(isset($_GET['page']))
{
  ...
  $comma_separated = implode(" ", $array);
	...
	$sql = "SELECT * FROM PHIM.PHIM WHERE TIEUDEKHONGDAU='$comma_separated'";
  ...
  $slx=$row[7]+1;
  $update="UPDATE PHIM.PHIM SET SOLUOTXEM='$slx' where TIEUDEKHONGDAU='$comma_separated'";
...
player = videojs("video", {
    ...
    player.updateSrc(<?php echo $sources; ?>)
            	...
            	<div class="div-title-single-content row">
            		<h3 class="h3-title-single-content"><?php echo $row[1];?>-<?php echo $row[2];?></h3>
            	</div>
              <div class="like-share-face row">
                <h4>Chia sẻ:</h4>
                <div class="fb-like" data-href="https://www.facebook.com/yeuphimle.net" data-layout="standard" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
              </div>
              
              <div class="send-face row text-center">
                <h4>Gửi Tin Nhắn Cho Bạn Bè Cùng Xem!</h4>
                <div class="fb-send" data-href="http://yeuphimle.net"></div>
              </div>
