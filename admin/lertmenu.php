...
Tất cả người dùng</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="index.php?page=danhsachdanhmuc&lv=<?php echo $_SESSION['level'];?>"><i class="fa fa-calendar"></i>
            Danh Sách</a></li>
          <li><a href="index.php?page=themdanhmuc&lv=<?php echo $_SESSION['level'];?>"><i class="fa fa-calendar-plus-o"></i>Thêm Danh Mục</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="index.php?page=danhsachslide&lv=<?php echo $_SESSION['level'];?>"><i class="fa fa-sliders"></i>
            Danh Sach Slide</a></li>
          <li><a href="index.php?page=themslide&lv=<?php echo $_SESSION['level'];?>"><i class="fa fa-plus-square-o"></i>Thêm Slide</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="index.php?page=danhsachphim"><i class="fa fa-film"></i>
            Danh Sach Phim</a></li>
          <li><a href="index.php?page=themphim"><i class="fa fa-file-video-o"></i>Thêm Phim</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="index.php?page=quangcao">
            <i class="fa fa-video-camera"></i>
            <span>Quản Lý Qảng Cáo</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
